		...
		try {
			...
			if(deallocationDetails!=null) { 
				...
				for (DeallocationDetails deallocationDetail : deallocationDetails) {	
					...
					System.out.println("Scheduler De From_id"+deallocationDetail.getFrom_id());
					System.out.println("Scheduler De End_time()"+deallocationDetail.getEnd_date()); 
					System.out.println("Scheduler De Workstation_no()"+deallocationDetail.getWorkstation_no()); 
					  
					deallocationDetail.setFrom_id("thiruvasagam@ation.co");
					deallocationDetail.setFrom_id("thiruvasagam.k@gmail.com"); 
