...
import com.wms.dao.deallocateunassigned.DeallocateTriggerDAO;
...
@Service
@EnableScheduling 
public class DeallocateEmailScheduler { 
	///* 
	...
	public void fixedDelayTask() {                           
		...
		try {
			List<DeAllocation> deallocationDetails = dTriggerDAO.getEmailJobs();  
			if(deallocationDetails!=null) { ///*
				...
				for (DeAllocation deallocationDetail : deallocationDetails) {	
					...
					//deallocationDetail.setId("thiruvasagam@ation.co");   
